...
if __name__ == '__main__':
  ...
  parser.add_argument("dataset", help="Dataset of Something or UCF101", type=str)
  ...
  try:
    ...
    if args.dataset == 'UCF101':
        ...
        for i, video in enumerate(videos):
          class_index[string.lower(video)] = i
          index_class[i] = string.lower(video)
    else:
        raise ValueError("Dataset should be Something or UCF101U")
